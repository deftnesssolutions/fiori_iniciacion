		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "InvoicesList",
									"targetURL": "#logalitraininvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalitraininvoices-display": {
								"semanticObject": "logalitraininvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logalitrain.invoices",
									"url": sap.ui.require.toUrl("logalitrain/invoices")
								}
							}
						}
					}
